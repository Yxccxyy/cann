...
bool OpRunner::RunOp()
{
    ...
    auto ret3 = aclrtSynchronizeStreamWithTimeout(stream, 5000);
    if (ret3 != SUCCESS) {
        ERROR_LOG("Synchronize stream failed. error code is %d", static_cast<int32_t>(ret3));
